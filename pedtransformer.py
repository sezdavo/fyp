...
class Trunk(nn.Module):
    ...
    def forward(self, x, q):
        ...
        # The processing of x below is for the position and context embedding of words in NLP
        # TO BE REMOVED (can this be used to encode position wrt time?)
